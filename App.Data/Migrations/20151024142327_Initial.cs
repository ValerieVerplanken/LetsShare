        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(isNullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ApplicationUserId = table.Column<string>(isNullable: true),
                    ...
                    Description = table.Column<string>(isNullable: true),
                    GroupName = table.Column<string>(type: "nvarchar(128)", isNullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_ApplicationUser_ApplicationUserId",
